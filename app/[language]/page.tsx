		...
		<div className="relative min-h-screen bg-black overflow-hidden flex flex-col">
			...
			<main className="flex flex-1 flex-col items-center justify-center text-center relative z-10">
				...
				<p className="text-gray-400 max-w-2xl mx-auto mb-8 text-base md:text-lg">
					Hi, I'm Nguyen Nhon Hau. A dedicated backend developer.
				</p>
				<div className="flex gap-4 justify-center">
					<a
						href="#projects"
						className="bg-emerald-400 hover:bg-emerald-500 text-black font-semibold py-3 px-7 rounded-full flex items-center gap-2 transition shadow-md"
					>
						See My Projects
			...
			<footer className="relative z-10 flex justify-center gap-8 pb-8 mt-auto">
				<a href="mailto:someone@example.com" className="text-white/80 hover:text-white transition" aria-label="Email">
					<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 12l-4 4m0 0l-4-4m4 4V4" />
					</svg>
				</a>
				<a href="https://github.com/" className="text-white/80 hover:text-white transition" aria-label="GitHub">
				...
				<a href="https://linkedin.com/" className="text-white/80 hover:text-white transition" aria-label="LinkedIn">
					<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
